...
import pl.schabik.infrastructure.persistence.JpaOrderId;
...
public class SqlOrderRepository implements OrderRepository {
    ...
    public Optional<Order> findById(OrderId id) {
        JpaOrderId jpaOrderId = DomainToPersistenceMapper.toJpaOrderId(id);
        return orderRepositoryJpa.findById(jpaOrderId)
                .map(PersistenceToDomainMapper::toDomain);
    }
}

@Repository
interface OrderRepositoryJpa extends CrudRepository<JpaOrderEntity, JpaOrderId> {
}
