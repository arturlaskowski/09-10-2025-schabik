...
class CreateOrderEndToEndTest {
    ...
    void givenRequestToAddOrderForExistingCustomer_whenRequestIsSent_thenOrderSavedAndHttp200() {
        ...
        var customerId = postCustomerResponse.getHeaders().getLocation().getPath().split("/")[2];
        ...
        //when - get order
        var getOrderResponse = restTemplate.getForEntity(location, GetOrderResponse.class);
